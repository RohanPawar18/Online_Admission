...
<script language="javascript">
	function Validate()
	{
		if(document.getElementById("grad_xam").value=="")
			{
				alert("please select Exams Passed");
				document.getElementById("grad_xam").focus();
				return false;
				
			}
		else if(document.getElementById("selstream1").value=="")
			{
				alert("please enter valid Stream/Discipline");
				document.getElementById("selstream1").focus();
				return false;
				
			}
		else if(document.getElementById("university1").value=="")
			{
				alert("please Enter Valid University / Board");
				document.getElementById("university1").focus();
				return false;
				
			}
		else if(document.getElementById("selresult1").value=="")
			{
				alert("please enter valid Year of Passing");
				document.getElementById("selresult1").focus();
				return false;
				
			}
		else if(document.getElementById("selmark1").value=="")
			{
		...
		if(document.getElementById("seldegree2").value=="")
			{
				alert("please select Exams Passed");
				document.getElementById("seldegree2").focus();
				return false;
				
			}
		else if(document.getElementById("selstream2").value=="")
			{
				alert("please enter valid Stream/Discipline");
		...
		else if(document.getElementById("university2").value=="")
			{
				alert("please Enter Valid University / Board");
				document.getElementById("university2").focus();
				return false;
				
			}
		else if(document.getElementById("selresult2").value=="")
			{
				alert("please enter valid Year of Passing");
				document.getElementById("selresult2").focus();
				return false;
				
			}
		else if(document.getElementById("selmark2").value=="")
			{
				alert("please enter % of Marks");
		...
		f(document.getElementById("seldegree3").value=="")
			{
				alert("please select Exams Passed");
		...
		else if(document.getElementById("selstream3").value=="")
			{
				alert("please enter valid Stream/Discipline");
		...
		else if(document.getElementById("university3").value=="")
			{
				alert("please Enter Valid University / Board");
				document.getElementById("university3").focus();
				return false;
				
			}
		else if(document.getElementById("selresult3").value=="")
			{
				alert("please enter valid Year of Passing");
				document.getElementById("selresult3").focus();
				return false;
				
			}
		else if(document.getElementById("selmark3").value=="")
			{
				alert("please enter % of Marks");
		...
		else if(document.getElementById("course_applied").value=="")
			{
				alert("please select Course Applied For");
				document.getElementById("course_applied").focus();
				return false;
		...
		<body bgcolor="#F0F4F1">
		<form name="form3" method="post" action="process_edu.php" onSubmit="return Validate()">
      ...
      <td class="tablecontent2">
		...
		<select width=30 size=1 name="course_applied" id="course_applied"  class="listMenu">
