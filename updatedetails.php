...
include("config.php");	
$query="SELECT * FROM pdetails where regId='".$_GET["regId"]."'";
...
<form id="reg_frm" name="reg_frm"  method="post" autocomplete="off" onSubmit="return Validate()" action="process_admform.php?action=update" >
	<input type="hidden" name="regId" id="regId" value="<?php echo($_GET["regId"]);?>"
...
<tr>
				...
				<input  size="3" name="age"  id="age" value="<?php echo $row["age"]; ?>"/>
				</td>
                </tr>
			    <tr>
				...
				<option selected value='<?php echo $row["Mstatus"]; ?>'><?php echo $row["Mstatus"]; ?></option>
...
<td class="tablecontent1">&nbsp;&nbsp;&nbsp;&nbsp Gender<span class="alert"><font color=red>*</font></span></td>
        ...
        <option selected value='><?php echo $row["opt_cat"]; ?>'>><?php echo $row["opt_cat"]; ?></option>
     ...
     <tr>
      ...
      <td class="tablecontent1">
		...
		<input type=text name="mname" id=mname size=31 maxlength=30 onChange="javascript:this.value=this.value.toUpperCase();" onkeypress='return (alphachar(event,number2) && alphactrl(event));' onkeydown="return alphactrl(event)" value="<?php echo $row["mname"]; ?>">
	...
	<input type=text name=fname id=fname size=31 maxlength=30 onChange="javascript:this.value=this.value.toUpperCase();" onkeypress='return (alphachar(event,number2) && alphactrl(event));'onkeydown="return alphactrl(event)" value="<?php echo $row["fname"]; ?>">
	...
	<input type=text name="nation" id="nationality" value='INDIAN' readonly size=31 maxlength=10>
      ...
      <td class="tablecontent2">
        ...
        <option selected value='<?php echo $row["religion"]; ?>'><?php echo $row["religion"]; ?>
    ...
    <TEXTAREA Name="address" id="address" ROWS=2 COLS=20 onChange="javascript:this.value=this.value.toUpperCase();" onkeypress="return (alphacharintspecial(event,number4) && alphactrl(event));" onkeydown="return alphactrl(event)" value="<?php echo $row["address"]; ?>">
 ...
 <option value='WEST BENGAL'>WEST BENGAL</option>
	  ...
	  <input name="pincode" id="pincode" onkeypress="return (number(event) && numberctrl(event));" onkeydown="return numberctrl(event);"  id=txtpin  maxlength=6 size=6 name=pincode value="<?php echo $row["pincode"]; ?>"/>
   ...
   <tr>
      <td class="tablecontent2">&nbsp;&nbsp;&nbsp;&nbsp Email address<span class="alert"><font color=red>*</font></span></td>
       <td class="tablecontent2">
		<input type=text name="email" id=email size=31  maxlength=45 onChange="return ValidateForm007();" onkeypress="return emailctrl(event);" onkeydown="return emailctrl(event);" value="<?php echo $row["email"]; ?>"><font color=#800080>[Maximum 45 character] 
...
<tr>
	...
	<input name="mobile" class="textbox2" id="mobile" onkeypress="return (number(event) && numberctrl(event));" onkeydown="return numberctrl(event);" size="25"  maxlength="10" value="<?php echo $row["mobile"]; ?>"/><font color=#800080>(10 digit)</font>
...
{  
  ...
  if ( $fullname ==""  ||$age ==""  || $Mstatus ==""  || $gender ==""  || $opt_cat ==""  || $mname ==""  ||
  ...
  echo " Cannot SUBMIT , Check mandatory  fields are empty !";
		...
		(fullname,age,Mstatus,gender,opt_cat,mname,fname,religion,address,state,pincode,email,mobile) 
		values
		('$fullname','$age','$Mstatus','$gender','$opt_cat','$mname','$fname','$religion','$address','$state','$pincode','$email','$mobile')")
